...
public enum CommonErrorEnum implements ICommonError{
    ...
    DATA_OP_ERROR(500, false, "DATABASE OPERATION ERROR,PLEASE CONTACT THE ADMINISTRATOR!"),
    AUTH_ERROR(501, true, "NO PERMISSION!"),
    PARAM_MISSING(502,false,"PARAM MISSING!"),
    HTTP_CONNECT_ERROR(507,false,"HTTP CONNECT ERROR!"),
    ;
